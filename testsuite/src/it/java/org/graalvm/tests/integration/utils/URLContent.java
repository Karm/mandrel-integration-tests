...
public enum URLContent {
    ...
    QUARKUS_FULL_MICROPROFILE(new String[][] {
            ...
            new String[] { "http://localhost:8080/" + (QUARKUS_VERSION.majorIs(1) ? "" : "q/") + "metrics",
            ...
            new String[] { "http://localhost:8080/data/metric/timed",
                    "Request is used in statistics, check with the Metrics call." },
            new String[] { "http://localhost:8080/data/secured/test", "Jessie specific value" },
            new String[] { "http://localhost:8080/data/client/test/parameterValue=xxx",
                    "Processed parameter value 'parameterValue=xxx'" }
    }),
