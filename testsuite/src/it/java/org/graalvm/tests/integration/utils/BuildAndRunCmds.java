...
public enum BuildAndRunCmds {
            ...
            new String[][]{
                    ...
                    {"mvn", "package", "-Pnative", "-Dquarkus.version=" + QUARKUS_VERSION.getVersionString(),
                            "-Dquarkus.native.additional-build-args=" +
                                    ...
                                    GRAALVM_BUILD_OUTPUT_JSON_FILE + "+ParseOnce",
                            "-Dfinal.name=quarkus-json_+ParseOnce"},
                    {"mvn", "package", "-Dfinal.name=quarkus-json", "-Dquarkus.version=" + QUARKUS_VERSION.getVersionString()}},
            //-XX:+UseShenandoahGC
            //-XX:+UseSerialGC
            //-XX:+UseG1GC
            new String[][]{
    ...
    TIMEZONES(
            new String[][]{
                    {"mvn", "package"},
                    {"native-image", "-J-Duser.country=CA", "-J-Duser.language=fr", "-jar", "target/timezones.jar", "target/timezones"}},
    ...
    IMAGEIO(
            new String[][]{
                    ...
                    {"native-image", "-J-Djava.awt.headless=true", "-H:IncludeResources=Grace_M._Hopper.jp2,MyFreeMono.ttf,MyFreeSerif.ttf", "--no-fallback", "-jar", "target/imageio.jar", "target/imageio"}},
    ...
    DEBUG_SYMBOLS_SMOKE(
            new String[][]{
                    ...
                    {"native-image", "-H:GenerateDebugInfo=1", "-H:+PreserveFramePointer", "-H:-DeleteLocalSymbols",
    ...
    JFR_OPTIONS(
            new String[][]{
                    {"mvn", "package"},
                    {"native-image", JFR_MONITORING_SWITCH_TOKEN, "-jar", "target/timezones.jar", "target/timezones"}}
            // @see JFRTest.java
    ),
